...
## 
## Makefile     : ins.mk
## Generated on : Mon Jan 23 18:38:20 2023
...
START_DIR                 = D:\Desktop\NoteRepo\毕设\Simulink_Model
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
DEFINES_STANDARD = -DMODEL=ins -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
{$(START_DIR)\ins_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\ins_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
ins.obj : "$(START_DIR)\ins_ert_rtw\ins.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ins_ert_rtw\ins.c"
